...
public class StateManagedBean implements Serializable {
    ...
    private List<TblState> selectedsatates;

    public List<TblState> getSelectedsatates() {
        return selectedsatates;
    }

    public void setSelectedsatates(List<TblState> selectedsatates) {
        this.selectedsatates = selectedsatates;
    }
